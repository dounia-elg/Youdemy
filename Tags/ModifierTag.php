...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold text-center mb-6">Modifier un Tag</h2>
        <form action="modifier_tag.php?id=<?php echo $id; ?>" method="POST" class="space-y-4">
            <div>
                <label for="tag_nom" class="block text-sm font-medium text-gray-700">Nom du Tag</label>
                <input type="text" id="tag_nom" name="tag_nom" required value="<?php echo htmlspecialchars($tag['nom']); ?>"
